    ...
    return (
      <div className="relative min-h-screen bg-gradient-to-br from-[#075E54] via-[#128C7E] to-[#25D366] overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <span className="text-xl font-bold text-[#075E54]">ReplyMate AI</span>
                  <div className="text-xs text-gray-500">WhatsApp Business Integration</div>
                </div>
              </div>

              <div className="hidden md:flex items-center space-x-6">
                <button className="text-[#075E54] hover:text-[#25D366] font-medium px-4 py-2">Features</button>
                <button className="text-[#075E54] hover:text-[#25D366] font-medium px-4 py-2">Pricing</button>
                <button className="text-[#075E54] hover:text-[#25D366] font-medium px-4 py-2">About</button>
                <button
                  className="flex items-center gap-2 text-[#075E54] border border-[#25D366] rounded-full px-4 py-2 hover:bg-[#25D366] hover:text-white transition-all"
                  onClick={handleLogin}
                >
                  <LogIn className="h-4 w-4" />
                  Login
                </button>
                <button className="flex items-center gap-2 bg-[#25D366] text-white rounded-full px-6 py-2 hover:bg-[#128C7E] transition-all shadow-lg">
                  Get Started Free
                </button>
              </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-white/95 backdrop-blur-lg border-t border-white/20">
              <div className="px-4 py-4 space-y-3">
                <button className="w-full text-left text-[#075E54] py-3 px-4">Features</button>
                <button className="w-full text-left text-[#075E54] py-3 px-4">Pricing</button>
                <button className="w-full text-left text-[#075E54] py-3 px-4">About</button>
                <button
                ...
                <button className="w-full text-left gap-2 bg-[#25D366] text-white rounded-full py-3 px-4 flex items-center">
                  Get Started Free
                </button>
              </div>
            </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 text-white mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <button
              className="text-lg px-8 py-4 bg-[#25D366] text-white rounded-full shadow-2xl hover:bg-[#128C7E] transition-all transform hover:scale-105 flex items-center gap-3 justify-center"
              onClick={handleLogin}
            >
              <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center">
                <ChatIcon className="w-4 h-4 text-[#25D366]" />
              </div>
              Start Free Trial - No Credit Card
            </button>
            <button className="text-lg px-8 py-4 border-2 border-white text-white rounded-full hover:bg-white hover:text-[#075E54] transition-all">
              Watch 2-Min Demo
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
              ...
              <div className="text-white/80">Businesses Connected</div>
              <div className="text-[#25D366] text-sm mt-2">↗ Growing daily</div>
            </div>
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
              <div className="text-4xl font-bold text-white mb-2">95%</div>
              <div className="text-white/80">Average Response Rate</div>
              <div className="text-[#25D366] text-sm mt-2">↗ 3x industry average</div>
            </div>
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
              <div className="text-4xl font-bold text-white mb-2">24/7</div>
              <div className="text-white/80">Automated Support</div>
              <div className="text-[#25D366] text-sm mt-2">↗ Never miss a customer</div>
            </div>
          </div>
        </div>

        {/* Features Preview */}
        <div className="relative z-10 bg-white/5 backdrop-blur-sm py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why Choose ReplyMate AI?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                >
                  <feature.icon className="w-8 h-8 text-[#25D366] mb-4" />
      ...
      <nav className="relative z-20 bg-white/95 backdrop-blur-lg border-b border-white/20 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button onClick={handleLogout} className="text-[#075E54] hover:text-[#25D366] font-medium px-4 py-2">
              Logout
            </button>
          </div>
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
            <h1 className="text-4xl font-bold text-white mb-3">Welcome back, John! 👋</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="w-12 h-12 bg-[#25D366]/10 rounded-full flex items-center justify-center">
                  <ChatIcon className="w-6 h-6 text-[#25D366]" />
                </div>
                <Badge className="bg-green-100 text-green-800 text-xs">Active</Badge>
              </div>
              <div className="text-3xl font-bold text-[#075E54] mb-1">{connectedBusinesses}</div>
              <div className="text-sm text-gray-600 mb-3">Connected Businesses</div>
              <div className="flex items-center">
                <TrendingUp className="h-4 w-4 text-[#25D366] mr-1" />
                <span className="text-sm text-[#25D366] font-medium">+1 this month</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/95 backdrop-blur-lg border-0 shadow-xl hover:shadow-2xl transition-all">
            <CardContent className="p-6">
              ...
              <div className="text-3xl font-bold text-[#075E54] mb-1">{responseRate}%</div>
              <div className="text-sm text-gray-600 mb-3">Response Rate</div>
              <div className="flex items-center">
                <TrendingUp className="h-4 w-4 text-[#25D366] mr-1" />
                <span className="text-sm text-[#25D366] font-medium">+3% this week</span>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
                  <Message className="w-6 h-6 text-purple-600" />
                </div>
                <Badge className="bg-purple-100 text-purple-800 text-xs">Today</Badge>
              </div>
              <div className="text-3xl font-bold text-[#075E54] mb-1">247</div>
              <div className="text-sm text-gray-600 mb-3">Messages Handled</div>
              <div className="flex items-center">
                <TrendingUp className="h-4 w-4 text-[#25D366] mr-1" />
                <span className="text-sm text-[#25D366] font-medium">+15% vs yesterday</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/95 backdrop-blur-lg border-0 shadow-xl hover:shadow-2xl transition-all">
            <CardContent className="p-6">
              ...
              <div className="text-3xl font-bold text-[#075E54] mb-1">1.2s</div>
              <div className="text-sm text-gray-600 mb-3">Response Time</div>
              <div className="flex items-center">
                <TrendingUp className="h-4 w-4 text-[#25D366] mr-1" />
                <span className="text-sm text-[#25D366] font-medium">Lightning fast</span>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="bg-white/95 backdrop-blur-lg border-0 shadow-xl">
          <CardContent className="p-8">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-2xl font-bold text-[#075E54] mb-2">Your WhatsApp Businesses</h2>
                <p className="text-gray-600">Manage and monitor your AI-powered business bots</p>
              </div>
              <button
                onClick={handleAddBusiness}
                className="bg-[#25D366] text-white rounded-full px-6 py-3 hover:bg-[#128C7E] transition-all shadow-lg flex items-center gap-2"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {businesses.map((biz, i) => (
                <div
                  key={`${biz.id}-${i}`}
                  className="group p-6 border-2 border-gray-100 rounded-2xl bg-gradient-to-br from-white to-gray-50 hover:border-[#25D366] hover:shadow-xl transition-all duration-300 cursor-pointer"
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-12 h-12 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                      <ChatIcon className="w-6 h-6 text-white" />
                    </div>
                  ...
                  <h3 className="text-lg font-bold text-[#075E54] mb-2 group-hover:text-[#25D366] transition-colors">
                    {biz.name}
                  </h3>

                  <div className="flex items-center gap-2 text-gray-600 mb-4">
                    <Phone className="w-4 h-4" />
                    <span className="text-sm">{biz.whatsapp_number}</span>
                  </div>
              ...
              <div
                onClick={handleAddBusiness}
                className="group p-6 border-2 border-dashed border-gray-300 rounded-2xl flex flex-col items-center justify-center text-center hover:border-[#25D366] hover:bg-[#25D366]/5 transition-all duration-300 cursor-pointer min-h-[280px]"
              >
                <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4 group-hover:bg-[#25D366] group-hover:scale-110 transition-all">
                  <Plus className="w-8 h-8 text-gray-400 group-hover:text-white" />
                </div>
                <h3 className="text-lg font-semibold text-gray-600 group-hover:text-[#25D366] mb-2">
                  Connect New Business
                </h3>
                <p className="text-sm text-gray-500 group-hover:text-gray-600">Set up WhatsApp AI in under 5 minutes</p>
              </div>
            </div>
          </CardContent>
        </Card>
